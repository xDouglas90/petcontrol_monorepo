...
-- Tempos médios de execução para cada serviço/sub-serviço, considerando características do pet
CREATE TABLE services_average_times(
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE INDEX idx_services_average_times_service ON services_average_times(service_id);

CREATE INDEX idx_services_average_times_sub_service ON services_average_times(sub_service_id);
