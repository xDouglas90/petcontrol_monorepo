...
func main() {
	...
	protected.GET("/company-users/:user_id/permissions", companyUserHandler.ListPermissions)
	protected.PATCH("/company-users/:user_id/permissions", companyUserHandler.UpdatePermissions)
