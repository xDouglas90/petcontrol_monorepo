...
func (s *PetService) ListPetsByCompanyID(ctx context.Context, companyID pgtype.UUID) ([]sqlc.ListPetsByCompanyIDRow, error) {
	return s.queries.ListPetsByCompanyID(ctx, companyID)
}
